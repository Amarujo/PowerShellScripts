...
import-csv .\sourcecsv |select-object @{name='column name you want';expression={$_.column1,$_.column1 -join 'add separator' }} | export-csv combinedcsv.csv -notypeinformation
